...
public class TicTacMethods {
	...
	// Method to place a player's sign
	...
	public static void computerTurnMethod(char gameBoard[][]) {
		...
		if (computerTurn == 1) {
			...
			if (gameBoard[4][4] == ' ') {
				...
				&& gameBoard[4][4] != ' ') {
			System.out.println("All positions are accupied. No winner in this game. Game is over!");
		}
	...
	public static boolean winnerCheck(char gameBoard[][]) {
		...
		if ((win1[0] =='O' && win1[1] =='O' && win1[2] =='O') ||
			(win2[0] =='O' && win2[1] =='O' && win2[2] =='O') ||
